...
class QueryAnalysis(BaseModel):
    ...
    event_dates:list[str]; query_date:str|None; requested_outcome:Literal["LOOKUP","EXPLAIN","ASSESS_LEGALITY","COMPARE","FIND_CASE","OTHER"]
...
class Evidence(BaseModel):
    ...
    graph_path:list[str]=Field(default_factory=list); verified:bool=False
...
class VerifiedEvidenceItem(BaseModel):
    ...
    official_url:str|None=None; audit_status:Literal["PASS"]="PASS"; warnings:list[str]=Field(default_factory=list)
