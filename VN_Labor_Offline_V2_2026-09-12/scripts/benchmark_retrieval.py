...
def main():
    ...
    report={'status':'PROVISIONAL_DRAFT_GOLD' if any(x.get('review_status')!='APPROVED' for x in gold) else 'OFFICIAL','build_id':pipe.store.report.gold_build_id,'results':results}
